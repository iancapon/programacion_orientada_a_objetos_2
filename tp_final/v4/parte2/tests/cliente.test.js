...
test("001 Cliente ian intenta prestar datos y minutos a nico, pero no tiene suficientes datos para prestar", () => {
    const fecha = new Date("2025-07-18T12:00:00");
    const ian = new Cliente(nombre = "ian", linea = 12345678)
    const nico = new Cliente(nombre = "nico", linea = 98765432)
    const paquete = new Paquete("Paquete Basico", costo = 1000, datos = 1000, minutos = 1000, duracion = 30, [])
...
test("001 Cliente ian intenta prestar datos y minutos a nico, pero no tiene suficientes minutos para prestar", () => {
    const fecha = new Date("2025-07-18T12:00:00");
    const ian = new Cliente(nombre = "ian", linea = 12345678)
    const nico = new Cliente(nombre = "nico", linea = 98765432)
    const paquete = new Paquete("Paquete Basico", costo = 1000, datos = 1000, minutos = 1000, duracion = 30, [])
...
test("001 Cliente ian le presta datos y minutos a nico", () => {
    const fecha = new Date("2025-07-18T12:00:00");
    const ian = new Cliente(nombre = "ian", linea = 12345678)
    const nico = new Cliente(nombre = "nico", linea = 98765432)
    const paquete = new Paquete("Paquete Basico", costo = 1000, datos = 1000, minutos = 1000, duracion = 30, [])

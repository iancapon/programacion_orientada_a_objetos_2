...
const { ConsumoDatos } = require("../src/Consumo")

describe("Creacion del sistema con sus paquetes y sus clientes", () => {
    test("001 Sistema no tiene registrado el cliente", () => {
...
describe("Interaccion del cliente con el sistema", () => {
